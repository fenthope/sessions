...
const (
	DefaultKey  = "github.com/touka-contrib/sessions"
...
func Sessions(name string, store Store) touka.HandlerFunc {
...
func SessionsMany(names []string, store Store) touka.HandlerFunc {
	return func(c *touka.Context) {
...
func SessionsManyStores(sessionStores []SessionStore) touka.HandlerFunc {
	return func(c *touka.Context) {
...
func Default(c *touka.Context) Session {
	return c.MustGet(DefaultKey).(Session)
}

// shortcut to get session with given name
func DefaultMany(c *touka.Context, name string) Session {
